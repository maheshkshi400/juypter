...
--QUERY EMPLOYEES INCREMENTED SALRY IF THEY HAVE COMEPLETED 2 YEARS WITH THE ORGANISATION



SELECT EMPKEY, FIRST_NAME, LAST_NAME,EMP_DEPT,HIRE_DATE,EMP_SALARY,EMP_SALARY*1.15 AS INCE_SAL,
DATEDIFF(YEAR,HIRE_DATE,'2010-12-31') AS EXPERIENCE FROM EMP4 
WHERE DATEDIFF(YEAR,HIRE_DATE,'2010-12-31') >= 15
