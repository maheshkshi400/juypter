...
3-1 = (SELECT COUNT(DISTINCT SAL)from EMP5 e2 where e2.SAL > e1.SAL);
...
SELECT E.EMPNO,E.SAL AS EMPLOYEE_SAL,E.JOB,M.SAL AS MANAGER_SAL FROM EMP5 E INNER JOIN 
EMP5 M ON E.EMPNO=M.MGR WHERE E.SAL>M.SAL;
